 ...
 */
class PHPParser_Node_Stmt_ForNumeric extends PHPParser_Node_Stmt
{
    /**
     ...
     */
    public function __construct(PHPParser_Node_Expr_Variable $variable,
    PHPParser_Node_Expr $from, PHPParser_Node_Expr $to,
    array $stmts = array(), $forloop_to, $optional_step,
    $line = -1, $docComment = null) {
        parent::__construct(
            array(
                'variable' => $variable,
                'from'  => $from,
                'to'  => $to,
                'forloop_to' => $forloop_to,
