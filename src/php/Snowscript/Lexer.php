...
{
    $i = 1001;
    $snow_token_names = array('T_IN', 'T_TO', 'T_DOWNTO', 'T_STEP', 'T_THEN', 'T_STRING_SINGLE', 'T_STRING_DOUBLE', 'T_DOUBLE_QUESTION_MARK', 'T_LBRACE', 'T_RBRACE');
    $snow_tokens = array();
...
class Snowscript_Lexer extends PHPParser_Lexer
{
    ...
    public function __construct($code) {
        ...
        $this->translated_tokens = array('T_NEWLINE' => ';', 'T_INDENT' => '{', 'T_DEDENT' => '}', 'T_BAND' => '&', 'T_BXOR' => '^', 'T_PERCENT' => '.', 'T_MOD' => '%', 'T_BNOT' => '~', 'T_BOR' => '|', 'T_LESS' => '<', 'T_NOT' => '!');
